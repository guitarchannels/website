	...
	"./src/index.tsx": function (e, t, a) {
											...
											l.a.createElement(
												...
												l.a.createElement(
													...
													l.a.createElement(
														...
														l.a.createElement("i", { className: "far fa-eye" })
													),
													" ",
													P(e.views)
												)
		...
		var Xe = function (e) {
			var t = Object(K.useLocalStorage)(G)[0],
				a = Object(g.useQuery)(Ze, { fetchPolicy: "cache-first", variables: { language: t || L } }),
				n = a.loading,
				r = (a.error, a.data),
				s = a.client;
			return n || !r
		...
		var Ot = function (e) {
			var t = Object(g.useLazyQuery)(jt, { fetchPolicy: "cache-first" }),
				a = t[0],
				n = t[1],
				r = n.loading,
				s = (n.error, n.data),
